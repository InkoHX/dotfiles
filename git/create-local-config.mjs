...
let email =
  await $`git config --global --get user.email || git config --file ~/.gitconfig-local --get user.email`
    .nothrow()
    .quiet()
let username =
  await $`git config --global --get user.name || git config --file ~/.gitconfig-local --get user.name`
    .nothrow()
    .quiet()
let signingKey =
  await $`git config --global --get user.signingkey || git config --file ~/.gitconfig-local --get user.signingkey`
    .nothrow()
    .quiet()
